...
| [Payload-dtype capability markers](issue-1308-capability-markers.md) | `98ebb52904633ac9346dfe96515060d9dad03dfa` | Single-precision staging: [#1065](https://github.com/Ryo-wtnb11/TeNeT/issues/1065); the split itself: [#1308](https://github.com/Ryo-wtnb11/TeNeT/issues/1308). |
