...
[`E_EXACT`](../tenet-network/examples/itebd_heisenberg.rs#L30). iTEBD tries to reach the
...
physical space is constructed in [`run`](../tenet-network/examples/itebd_heisenberg.rs#L162-L167).
...
terms flip the two spins. [`heisenberg_two_site`](../tenet-network/examples/itebd_heisenberg.rs#L50-L69)
...
be identical during the update. [`State`](../tenet-network/examples/itebd_heisenberg.rs#L110-L138)
...
[`run`](../tenet-network/examples/itebd_heisenberg.rs#L161-L190) constructs this gate
with `h.scale(-dt).exp()`. [`State::step`](../tenet-network/examples/itebd_heisenberg.rs#L140-L150)
...
[`bond_update`](../tenet-network/examples/itebd_heisenberg.rs#L71-L93) absorbs the two
...
[`run`](../tenet-network/examples/itebd_heisenberg.rs#L162-L169) combines a bond budget
...
are the final part of [`bond_update`](../tenet-network/examples/itebd_heisenberg.rs#L84-L92).
...
[`bond_energy`](../tenet-network/examples/itebd_heisenberg.rs#L95-L103) evaluates the
normalized local expectation value
$\langle\theta\rvert h\lvert\theta\rangle/\langle\theta\vert\theta\rangle$.
[`State::energy`](../tenet-network/examples/itebd_heisenberg.rs#L153-L158) averages the
A-B and B-A bond energies. The schedule in [`main`](../tenet-network/examples/itebd_heisenberg.rs#L194-L215)
