...
pub use factorize::{
    ...
    svd_full, svd_full_dyn, svd_full_dyn_checked_generic, svd_trunc, svd_trunc_dyn,
    svd_trunc_dyn_generic, svd_trunc_factors_dyn, svd_trunc_factors_dyn_checked_generic,
