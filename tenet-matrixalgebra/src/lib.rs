...
pub use factorize::{
    ...
    svd_trunc_factors_dyn_generic, svd_vals, svd_vals_dyn, svd_vals_dyn_checked_generic,
    svd_vals_dyn_generic, BoundDynFactor, BoundDynamicTensorRef, BoundTensorMap, BoundTensorMapRef,
    CheckedGenericFactorPlanError, EigFull, EigFullDyn, EigTrunc, EigTruncDyn, EighFull,
