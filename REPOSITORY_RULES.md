...
- **Compare arithmetic with tolerances.** Assert bit equality only for data movement, determinism, and combinatorial output; compare other floating-point results with an independent oracle under the rule in [docs/testing_numerics.md](docs/testing_numerics.md).
