...
/// operation contexts. The `tenet-tensors` crate is the source of truth for
/// input ownership, validation, and how each operation changes its destination.
pub mod operations {
...
/// [`core::TensorMap`] and supplies its own dense executor. The
/// `tenet-matrixalgebra` crate is the source of truth for who owns each input
/// and output.
